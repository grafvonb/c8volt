...
type API interface {
	...
	AnalyseAPILatency(ctx context.Context, request APILatencyRequest, opts ...options.FacadeOption) (APILatencyResult, error)
	ExecuteAPILatencyTest(ctx context.Context, request APILatencyRequest, opts ...options.FacadeOption) (APILatencyResult, error)
