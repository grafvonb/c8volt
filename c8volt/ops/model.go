...
// SlowProcessAnalysisTimelineEntryKind identifies a rendered analysis timeline row.
...
// SlowProcessAnalysisRequest captures the public input for one slow analysis run.
...
// SlowProcessAnalysisProcessInstanceSearchFilters carries process-instance discovery filters.
...
// APILatencyBackoff captures the bounded visibility retry policy for facade callers.
