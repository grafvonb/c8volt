...
c8volt ops execute retention-policy --retention-days 90 --bpmn-process-id invoice-process --state completed --auto-confirm
...
```bash
c8volt ops execute retention-policy --retention-days 90 --dry-run
c8volt ops execute retention-policy --retention-days 90 --auto-confirm --report-file /tmp/c8volt-vhs/reports/retention-report.md
```
