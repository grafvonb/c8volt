...
- Remaining US3-adjacent gaps are process-definition purge/delete candidates, orphan purge candidates, ops repair-specific mixed failure report rows, and a durable standalone resolve fixture that does not immediately recreate the incident after resolution.
