...
- Remaining US3 work is mixed valid/missing/malformed/stale/already-mutated target sets, fail-fast/partial-failure accounting, process-definition purge/delete candidates, orphan purge candidates, and a durable standalone resolve fixture that does not immediately recreate the incident after resolution.
