...
- [ ] T002 [P] Add failing completion-kind, disposition, identity, failure-detail, and nil-versus-zero affected-count mapping tests in `internal/domain/ops_progress_test.go`, `c8volt/foptions/options_test.go`, and `c8volt/ops/model_test.go`
- [ ] T003 Implement the canonical completion fact and mechanical callback propagation in `internal/domain/ops_progress.go`, `internal/services/calloption.go`, `c8volt/foptions/options.go`, `c8volt/ops/progress_model.go`, and `c8volt/ops/convert.go`
