...
## Current Handoff
- Next iteration should start Phase 3 / US1 at T010, adding named/empty tenant selector and pre-confirmation ordering tests for cancel workflows in `cmd/cancel_processinstance_selector_test.go` and `cmd/cancel_processinstance_test.go`; T011/T012 remain parallel US1 test tasks after T010.
