...
## Codebase Patterns
- First incomplete work now begins at US4 T050; foundational API-latency domain/service/facade contracts T003-T013, read-only analyse implementation/evidence T014-T023, bounded active US2 command/service/facade/rendering work T024-T035, US3 ownership/cleanup/recovery preservation work T036-T046, US4 renderer regression coverage T047, report coverage/rendering/wiring T048/T052/T053, and output-safety/progress coverage T049 are complete.
...
## Current Handoff
- Next iteration should continue US4 at T050 by adding subprocess tests proving completed abnormal evidence exits successfully while invalid, incomplete, report-failed, and requested-cleanup-failed runs use the established nonzero error envelope in `cmd/ops_analyse_api_latency_test.go` and `cmd/ops_execute_api_latency_test.go`.
