...
- Latest logging review: existing debug DEBUG logging, quiet/level/format behavior, ASCII message grammar and effective command stderr replace the earlier dedicated-output exception. Tests cover logger formats and untouched stdout/prompts; no product code is implemented by these artifact edits.
