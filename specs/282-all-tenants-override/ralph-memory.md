...
## Current Handoff
- Next iteration starts Phase 4 / US2 at task T020: add tenant-choice conflict and unchanged-behavior tests in `cmd/root_test.go`; T021 in `cmd/bootstrap_errors_test.go` can be prepared in the same US2 work unit if time allows.
