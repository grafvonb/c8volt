...
## Current Handoff
- Continue Phase 6 / US4 at task T037: add root, applicable-command, and four concrete-destination help assertions in `cmd/root_test.go`, `cmd/deploy_test.go`, `cmd/embed_test.go`, `cmd/run_test.go`, and `cmd/ops_execute_smoke_test_test.go`; capability metadata work T036/T040/T041 is complete and validated.
