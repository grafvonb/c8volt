...
## Current Handoff
- Next iteration starts at Phase 3 / US1 task T013: add human, JSON, and YAML tenant-context isolation tests for active `--all-tenants` in `cmd/config_test.go`. T011, T012, and T016-T018 are implemented and validated; T014-T015 and T019 remain open after T013.
