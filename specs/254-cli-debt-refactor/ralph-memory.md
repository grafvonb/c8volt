...
## Current Handoff
- Continue Phase 4 / US2 at T042. Move process-instance cancel/delete discovery and mutation planning traversal below command ownership while preserving delete's frozen-scope safety contract: all page plans are collected before one confirmation and one aggregate delete call.
