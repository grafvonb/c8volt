...
- [ ] T026 [P] [US2] Add service/facade page-collection tests for job search in `c8volt/job/client_test.go` and `internal/services/job/v88/service_test.go`
- [ ] T027 [P] [US2] Add service/facade page-collection tests for element search in `c8volt/element/client_test.go` and `internal/services/element/v88/service_test.go`
