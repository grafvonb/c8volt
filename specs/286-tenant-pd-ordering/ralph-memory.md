...
## Current Handoff
- Next iteration starts at T010: add Camunda 8.10 ordinary request-sort and returned-order assertions to `internal/services/processdefinition/v810/service_test.go`; pair with T014 if the regression exposes the same ordinary adapter sort gap.
