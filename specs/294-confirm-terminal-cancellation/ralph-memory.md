...
- `make test` passed for iterations 13–15 after the v8.7, v8.8, and v8.9 contract F–H compatibility additions.

## Do Not Repeat

## Current Handoff
- Continue US3 with T026: add equivalent contract F–H compatibility coverage to the v8.10 service tests without changing production behavior.
