...
- `make test` is the required pre-commit gate and passed for iterations 1 and 3.

## Do Not Repeat

## Current Handoff
- Continue US1 with T004/T008: add the v8.8 contract A–E regressions, capture the old failures, apply the paired cancellation fix, and validate the package.
