...
- `docs/use-cases.md` already contains the strongest script/CI positioning and explicitly calls out automation-friendly flags. It is the best user-facing anchor for explaining why `capabilities --json` and the shared result envelope are the supported machine surface.
