...
func (stubProcessAPI) ResolveProcessInstancesIncidents(context.Context, types.Keys, int, ...options.FacadeOption) (process.ProcessInstanceResolutionResults, error) {
	panic("unexpected call")
}
