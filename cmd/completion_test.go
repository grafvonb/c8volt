...
func TestRootCompletion_TopLevelSuggestionsStayReadable(t *testing.T) {
	...
	require.Contains(t, output, "get\tInspect cluster, process, job, element, incident, tenant, and resource state\n")
...
func TestNestedCompletion_SubcommandsStayUserFacing(t *testing.T) {
	...
	require.Contains(t, output, "user-task\tFetch or search native user tasks\n")
