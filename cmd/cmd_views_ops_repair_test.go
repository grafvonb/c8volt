...
func TestRenderOpsRepairIncidentDryRunSearchHumanOutput(t *testing.T) {
	...
	require.Contains(t, output, "repair preview: 2 active incident(s) would be resolved; 1 related job(s), 0 variable scope(s) would be updated")
	require.Contains(t, output, "job repair coverage: 1 related job(s), 1 incident(s) without related jobs")
...
func TestRenderOpsRepairProcessInstanceDryRunSearchHumanOutput(t *testing.T) {
	...
	require.Contains(t, output, "repairable process instances: 1")
