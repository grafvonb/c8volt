...
.PHONY: help all tidy generate generate-clients build test lint fmt vet clean install run cover cover.html release docs docs-content docs-site-install docs-site-build docs-site-serve
