...
func writeSummaryFile(path string, metadata runMetadata, exitCode int) error {
	...
	b.WriteString("- `real-state-<family>.json`\n")
	b.WriteString("- `real-state-data-<family>.json`\n")
	b.WriteString("- `real-state-progress-<family>.json`\n")
	b.WriteString("- `real-state-ops-reports-<family>.json`\n")
	b.WriteString("- `logs/`\n")
	b.WriteString("- `data/`\n")
