...
func readBehaviorScenarios() []behaviorScenario {
	return []behaviorScenario{
		...
		{CommandPath: "get user-task", Name: "behavior-get-user-task-json-pi-key", Args: []string{"--json", "get", "ut", "--pi-key", "{pi-key}"}, RequiresProfile: true, RequiresSeed: true, OutputMode: "json", Behavior: behaviorSuccess, VersionBehavior: "selected-profile-version-gated", DataOwnership: []string{"seeded"}, WantJSON: true, CoveredFlags: []string{"pi-key"}, AllowUnsupportedVersions: []string{"8.7"}},
