...
func allVolumeTargets() []volumeTarget {
	return []volumeTarget{
		...
		{Name: "integration-cli-walk-volume", Family: "walk", TestPattern: "TestVolumeWalkFamily", DefaultDatasetCount: defaultITVolumeCount, Destructive: true, ReservedNotImplemented: true},
		{Name: "integration-cli-update-volume", Family: "update", TestPattern: "TestVolumeUpdateFamily", DefaultDatasetCount: defaultITVolumeCount, Destructive: true, ReservedNotImplemented: true},
		...
		{Name: "integration-cli-deploy-embed-run-volume", Family: "deploy-embed-run", TestPattern: "TestVolumeDeployEmbedRunFamily", DefaultDatasetCount: defaultITVolumeCount, Destructive: true, ReservedNotImplemented: true},
		{Name: "integration-cli-ops-analyse-volume", Family: "ops-analyse", TestPattern: "TestVolumeOpsAnalyseFamily", DefaultDatasetCount: defaultITVolumeCount, Destructive: true, ReservedNotImplemented: true},
