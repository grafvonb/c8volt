...
// Defines values for DocumentReferenceDocumentType.
const (
	Camunda DocumentReferenceDocumentType = "camunda"
)
...
type DocumentReference struct {
	...
	// DocumentType Document discriminator. Always set to "camunda".
	DocumentType *DocumentReferenceDocumentType `json:"documentType,omitempty"`
...
// DocumentReferenceDocumentType Document discriminator. Always set to "camunda".
type DocumentReferenceDocumentType string
...
// PostDocumentDocumentIdLinksParams defines parameters for PostDocumentDocumentIdLinks.
type PostDocumentDocumentIdLinksParams struct {
...
// PostDocumentsMultipartBody defines parameters for PostDocuments.
type PostDocumentsMultipartBody struct {
...
type PostDocumentsParams struct {
	// StoreId The ID of the document store to upload the document to.
	StoreId *string `form:"storeId,omitempty" json:"storeId,omitempty"`
...
// DeleteDocumentsDocumentIdParams defines parameters for DeleteDocumentsDocumentId.
type DeleteDocumentsDocumentIdParams struct {
	// StoreId The ID of the document store to delete the document from.
	StoreId *string `form:"storeId,omitempty" json:"storeId,omitempty"`
}

// GetDocumentsDocumentIdParams defines parameters for GetDocumentsDocumentId.
type GetDocumentsDocumentIdParams struct {
...
type PostDecisionDefinitionsEvaluationJSONRequestBody = EvaluateDecisionRequest
...
type PostDecisionDefinitionsSearchJSONRequestBody = DecisionDefinitionSearchQueryRequest
...
type PostDecisionInstancesSearchJSONRequestBody = DecisionInstanceSearchQueryRequest
...
type PostDecisionRequirementsSearchJSONRequestBody = DecisionRequirementsSearchQueryRequest
...
// PostDocumentDocumentIdLinksJSONRequestBody defines body for PostDocumentDocumentIdLinks for application/json ContentType.
type PostDocumentDocumentIdLinksJSONRequestBody = DocumentLinkRequest

// PostDocumentsMultipartRequestBody defines body for PostDocuments for multipart/form-data ContentType.
type PostDocumentsMultipartRequestBody PostDocumentsMultipartBody
...
type PostFlownodeInstancesSearchJSONRequestBody = FlowNodeInstanceSearchQueryRequest
...
type PostIncidentsSearchJSONRequestBody = IncidentSearchQueryRequest
...
type PostProcessInstancesJSONRequestBody = CreateProcessInstanceRequest
...
type PostProcessInstancesSearchJSONRequestBody = ProcessInstanceSearchQueryRequest
...
type PostProcessInstancesProcessInstanceKeyMigrationJSONRequestBody = MigrateProcessInstanceRequest
...
type PostProcessInstancesProcessInstanceKeyModificationJSONRequestBody = ModifyProcessInstanceRequest
...
type PostUserTasksSearchJSONRequestBody = UserTaskSearchQueryRequest
...
// Getter for additional properties for DocumentMetadata. Returns the specified
// element and whether it was found
func (a DocumentMetadata) Get(fieldName string) (value interface{}, found bool) {
	if a.AdditionalProperties != nil {
		value, found = a.AdditionalProperties[fieldName]
	}
	return
...
// Setter for additional properties for DocumentMetadata
func (a *DocumentMetadata) Set(fieldName string, value interface{}) {
	if a.AdditionalProperties == nil {
		a.AdditionalProperties = make(map[string]interface{})
	}
	a.AdditionalProperties[fieldName] = value
...
// Override default JSON handling for DocumentMetadata to handle AdditionalProperties
func (a *DocumentMetadata) UnmarshalJSON(b []byte) error {
	object := make(map[string]json.RawMessage)
	err := json.Unmarshal(b, &object)
	if err != nil {
		return err
...
// Override default JSON handling for DocumentMetadata to handle AdditionalProperties
func (a DocumentMetadata) MarshalJSON() ([]byte, error) {
	var err error
	object := make(map[string]json.RawMessage)
...
type ClientInterface interface {
	...
	GetDecisionDefinitionsDecisionDefinitionKeyXml(ctx context.Context, decisionDefinitionKey int64, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	// PostDocumentDocumentIdLinksWithBody request with any body
	PostDocumentDocumentIdLinksWithBody(ctx context.Context, documentId string, params *PostDocumentDocumentIdLinksParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	PostDocumentDocumentIdLinks(ctx context.Context, documentId string, params *PostDocumentDocumentIdLinksParams, body PostDocumentDocumentIdLinksJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	// DeleteDocumentsDocumentId request
	DeleteDocumentsDocumentId(ctx context.Context, documentId string, params *DeleteDocumentsDocumentIdParams, reqEditors ...RequestEditorFn) (*http.Response, error)

	// GetDocumentsDocumentId request
	GetDocumentsDocumentId(ctx context.Context, documentId string, params *GetDocumentsDocumentIdParams, reqEditors ...RequestEditorFn) (*http.Response, error)

	// PutElementInstancesElementInstanceKeyVariablesWithBody request with any body
	PutElementInstancesElementInstanceKeyVariablesWithBody(ctx context.Context, elementInstanceKey int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	PutElementInstancesElementInstanceKeyVariables(ctx context.Context, elementInstanceKey int64, body PutElementInstancesElementInstanceKeyVariablesJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	GetIncidentsIncidentKey(ctx context.Context, incidentKey int64, reqEditors ...RequestEditorFn) (*http.Response, error)

	// PostIncidentsIncidentKeyResolution request
	PostIncidentsIncidentKeyResolution(ctx context.Context, incidentKey int64, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	PatchJobsJobKeyWithBody(ctx context.Context, jobKey int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	PatchJobsJobKey(ctx context.Context, jobKey int64, body PatchJobsJobKeyJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// PostJobsJobKeyCompletionWithBody request with any body
	PostJobsJobKeyCompletionWithBody(ctx context.Context, jobKey int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	PostJobsJobKeyCompletion(ctx context.Context, jobKey int64, body PostJobsJobKeyCompletionJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// ThrowJobErrorWithBody request with any body
	ThrowJobErrorWithBody(ctx context.Context, jobKey int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	ThrowJobError(ctx context.Context, jobKey int64, body ThrowJobErrorJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// PostJobsJobKeyFailureWithBody request with any body
	PostJobsJobKeyFailureWithBody(ctx context.Context, jobKey int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	PostJobsJobKeyFailure(ctx context.Context, jobKey int64, body PostJobsJobKeyFailureJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	PostProcessInstancesProcessInstanceKeyCancellationWithBody(ctx context.Context, processInstanceKey int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	PostProcessInstancesProcessInstanceKeyCancellation(ctx context.Context, processInstanceKey int64, body PostProcessInstancesProcessInstanceKeyCancellationJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// PostProcessInstancesProcessInstanceKeyMigrationWithBody request with any body
	PostProcessInstancesProcessInstanceKeyMigrationWithBody(ctx context.Context, processInstanceKey int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	PostProcessInstancesProcessInstanceKeyMigration(ctx context.Context, processInstanceKey int64, body PostProcessInstancesProcessInstanceKeyMigrationJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	PostProcessInstancesProcessInstanceKeyMigrationWithApplicationVndCamundaAPIKeysNumberPlusJSONBody(ctx context.Context, processInstanceKey int64, body PostProcessInstancesProcessInstanceKeyMigrationApplicationVndCamundaAPIKeysNumberPlusJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	PostProcessInstancesProcessInstanceKeyMigrationWithApplicationVndCamundaAPIKeysStringPlusJSONBody(ctx context.Context, processInstanceKey int64, body PostProcessInstancesProcessInstanceKeyMigrationApplicationVndCamundaAPIKeysStringPlusJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// PostProcessInstancesProcessInstanceKeyModificationWithBody request with any body
	PostProcessInstancesProcessInstanceKeyModificationWithBody(ctx context.Context, processInstanceKey int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	PostProcessInstancesProcessInstanceKeyModification(ctx context.Context, processInstanceKey int64, body PostProcessInstancesProcessInstanceKeyModificationJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	PostProcessInstancesProcessInstanceKeyModificationWithApplicationVndCamundaAPIKeysNumberPlusJSONBody(ctx context.Context, processInstanceKey int64, body PostProcessInstancesProcessInstanceKeyModificationApplicationVndCamundaAPIKeysNumberPlusJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	PostProcessInstancesProcessInstanceKeyModificationWithApplicationVndCamundaAPIKeysStringPlusJSONBody(ctx context.Context, processInstanceKey int64, body PostProcessInstancesProcessInstanceKeyModificationApplicationVndCamundaAPIKeysStringPlusJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// PostResourcesResourceKeyDeletionWithBody request with any body
	PostResourcesResourceKeyDeletionWithBody(ctx context.Context, resourceKey int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	PostResourcesResourceKeyDeletion(ctx context.Context, resourceKey int64, body PostResourcesResourceKeyDeletionJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) GetDecisionDefinitionsDecisionDefinitionKeyXml(ctx context.Context, decisionDefinitionKey int64, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) PostDocumentDocumentIdLinksWithBody(ctx context.Context, documentId string, params *PostDocumentDocumentIdLinksParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewPostDocumentDocumentIdLinksRequestWithBody(c.Server, documentId, params, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) PostDocumentDocumentIdLinks(ctx context.Context, documentId string, params *PostDocumentDocumentIdLinksParams, body PostDocumentDocumentIdLinksJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewPostDocumentDocumentIdLinksRequest(c.Server, documentId, params, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) DeleteDocumentsDocumentId(ctx context.Context, documentId string, params *DeleteDocumentsDocumentIdParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewDeleteDocumentsDocumentIdRequest(c.Server, documentId, params)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) GetDocumentsDocumentId(ctx context.Context, documentId string, params *GetDocumentsDocumentIdParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetDocumentsDocumentIdRequest(c.Server, documentId, params)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) PutElementInstancesElementInstanceKeyVariablesWithBody(ctx context.Context, elementInstanceKey int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) PutElementInstancesElementInstanceKeyVariables(ctx context.Context, elementInstanceKey int64, body PutElementInstancesElementInstanceKeyVariablesJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) GetIncidentsIncidentKey(ctx context.Context, incidentKey int64, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) PostIncidentsIncidentKeyResolution(ctx context.Context, incidentKey int64, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) PatchJobsJobKeyWithBody(ctx context.Context, jobKey int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) PatchJobsJobKey(ctx context.Context, jobKey int64, body PatchJobsJobKeyJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) PostJobsJobKeyCompletionWithBody(ctx context.Context, jobKey int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) PostJobsJobKeyCompletion(ctx context.Context, jobKey int64, body PostJobsJobKeyCompletionJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) ThrowJobErrorWithBody(ctx context.Context, jobKey int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) ThrowJobError(ctx context.Context, jobKey int64, body ThrowJobErrorJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) PostJobsJobKeyFailureWithBody(ctx context.Context, jobKey int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) PostJobsJobKeyFailure(ctx context.Context, jobKey int64, body PostJobsJobKeyFailureJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) PostProcessInstancesProcessInstanceKeyCancellationWithBody(ctx context.Context, processInstanceKey int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) PostProcessInstancesProcessInstanceKeyCancellation(ctx context.Context, processInstanceKey int64, body PostProcessInstancesProcessInstanceKeyCancellationJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) PostProcessInstancesProcessInstanceKeyMigrationWithBody(ctx context.Context, processInstanceKey int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) PostProcessInstancesProcessInstanceKeyMigration(ctx context.Context, processInstanceKey int64, body PostProcessInstancesProcessInstanceKeyMigrationJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) PostProcessInstancesProcessInstanceKeyMigrationWithApplicationVndCamundaAPIKeysNumberPlusJSONBody(ctx context.Context, processInstanceKey int64, body PostProcessInstancesProcessInstanceKeyMigrationApplicationVndCamundaAPIKeysNumberPlusJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) PostProcessInstancesProcessInstanceKeyMigrationWithApplicationVndCamundaAPIKeysStringPlusJSONBody(ctx context.Context, processInstanceKey int64, body PostProcessInstancesProcessInstanceKeyMigrationApplicationVndCamundaAPIKeysStringPlusJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) PostProcessInstancesProcessInstanceKeyModificationWithBody(ctx context.Context, processInstanceKey int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) PostProcessInstancesProcessInstanceKeyModification(ctx context.Context, processInstanceKey int64, body PostProcessInstancesProcessInstanceKeyModificationJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) PostProcessInstancesProcessInstanceKeyModificationWithApplicationVndCamundaAPIKeysStringPlusJSONBody(ctx context.Context, processInstanceKey int64, body PostProcessInstancesProcessInstanceKeyModificationApplicationVndCamundaAPIKeysStringPlusJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) PostResourcesResourceKeyDeletionWithBody(ctx context.Context, resourceKey int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) PostResourcesResourceKeyDeletion(ctx context.Context, resourceKey int64, body PostResourcesResourceKeyDeletionJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func NewGetDecisionDefinitionsDecisionDefinitionKeyXmlRequest(server string, decisionDefinitionKey int64) (*http.Request, error) {
	var err error
...
// NewPostDocumentDocumentIdLinksRequest calls the generic PostDocumentDocumentIdLinks builder with application/json body
func NewPostDocumentDocumentIdLinksRequest(server string, documentId string, params *PostDocumentDocumentIdLinksParams, body PostDocumentDocumentIdLinksJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewPostDocumentDocumentIdLinksRequestWithBody(server, documentId, params, "application/json", bodyReader)
}

// NewPostDocumentDocumentIdLinksRequestWithBody generates requests for PostDocumentDocumentIdLinks with any type of body
func NewPostDocumentDocumentIdLinksRequestWithBody(server string, documentId string, params *PostDocumentDocumentIdLinksParams, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
// NewDeleteDocumentsDocumentIdRequest generates requests for DeleteDocumentsDocumentId
func NewDeleteDocumentsDocumentIdRequest(server string, documentId string, params *DeleteDocumentsDocumentIdParams) (*http.Request, error) {
	var err error
...
func NewGetDocumentsDocumentIdRequest(server string, documentId string, params *GetDocumentsDocumentIdParams) (*http.Request, error) {
	var err error
...
func NewPutElementInstancesElementInstanceKeyVariablesRequest(server string, elementInstanceKey int64, body PutElementInstancesElementInstanceKeyVariablesJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
...
func NewPutElementInstancesElementInstanceKeyVariablesRequestWithBody(server string, elementInstanceKey int64, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
func NewGetIncidentsIncidentKeyRequest(server string, incidentKey int64) (*http.Request, error) {
	var err error
...
func NewPostIncidentsIncidentKeyResolutionRequest(server string, incidentKey int64) (*http.Request, error) {
	var err error
...
func NewPatchJobsJobKeyRequest(server string, jobKey int64, body PatchJobsJobKeyJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
...
func NewPatchJobsJobKeyRequestWithBody(server string, jobKey int64, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
func NewPostJobsJobKeyCompletionRequest(server string, jobKey int64, body PostJobsJobKeyCompletionJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
...
func NewPostJobsJobKeyCompletionRequestWithBody(server string, jobKey int64, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
func NewThrowJobErrorRequest(server string, jobKey int64, body ThrowJobErrorJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
...
func NewThrowJobErrorRequestWithBody(server string, jobKey int64, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
func NewPostJobsJobKeyFailureRequest(server string, jobKey int64, body PostJobsJobKeyFailureJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
...
func NewPostJobsJobKeyFailureRequestWithBody(server string, jobKey int64, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
func NewPostProcessInstancesProcessInstanceKeyCancellationRequest(server string, processInstanceKey int64, body PostProcessInstancesProcessInstanceKeyCancellationJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
...
func NewPostProcessInstancesProcessInstanceKeyCancellationRequestWithBody(server string, processInstanceKey int64, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
func NewPostProcessInstancesProcessInstanceKeyMigrationRequest(server string, processInstanceKey int64, body PostProcessInstancesProcessInstanceKeyMigrationJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
...
func NewPostProcessInstancesProcessInstanceKeyMigrationRequestWithApplicationVndCamundaAPIKeysNumberPlusJSONBody(server string, processInstanceKey int64, body PostProcessInstancesProcessInstanceKeyMigrationApplicationVndCamundaAPIKeysNumberPlusJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
...
func NewPostProcessInstancesProcessInstanceKeyMigrationRequestWithApplicationVndCamundaAPIKeysStringPlusJSONBody(server string, processInstanceKey int64, body PostProcessInstancesProcessInstanceKeyMigrationApplicationVndCamundaAPIKeysStringPlusJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
...
func NewPostProcessInstancesProcessInstanceKeyMigrationRequestWithBody(server string, processInstanceKey int64, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
func NewPostProcessInstancesProcessInstanceKeyModificationRequest(server string, processInstanceKey int64, body PostProcessInstancesProcessInstanceKeyModificationJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
...
func NewPostProcessInstancesProcessInstanceKeyModificationRequestWithApplicationVndCamundaAPIKeysNumberPlusJSONBody(server string, processInstanceKey int64, body PostProcessInstancesProcessInstanceKeyModificationApplicationVndCamundaAPIKeysNumberPlusJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
...
func NewPostProcessInstancesProcessInstanceKeyModificationRequestWithApplicationVndCamundaAPIKeysStringPlusJSONBody(server string, processInstanceKey int64, body PostProcessInstancesProcessInstanceKeyModificationApplicationVndCamundaAPIKeysStringPlusJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
...
func NewPostProcessInstancesProcessInstanceKeyModificationRequestWithBody(server string, processInstanceKey int64, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
func NewPostResourcesResourceKeyDeletionRequest(server string, resourceKey int64, body PostResourcesResourceKeyDeletionJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
...
func NewPostResourcesResourceKeyDeletionRequestWithBody(server string, resourceKey int64, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	GetDecisionDefinitionsDecisionDefinitionKeyXmlWithResponse(ctx context.Context, decisionDefinitionKey int64, reqEditors ...RequestEditorFn) (*GetDecisionDefinitionsDecisionDefinitionKeyXmlResponse, error)
	...
	// PostDocumentDocumentIdLinksWithBodyWithResponse request with any body
	PostDocumentDocumentIdLinksWithBodyWithResponse(ctx context.Context, documentId string, params *PostDocumentDocumentIdLinksParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PostDocumentDocumentIdLinksResponse, error)

	PostDocumentDocumentIdLinksWithResponse(ctx context.Context, documentId string, params *PostDocumentDocumentIdLinksParams, body PostDocumentDocumentIdLinksJSONRequestBody, reqEditors ...RequestEditorFn) (*PostDocumentDocumentIdLinksResponse, error)

	// PostDocumentsWithBodyWithResponse request with any body
	PostDocumentsWithBodyWithResponse(ctx context.Context, params *PostDocumentsParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PostDocumentsResponse, error)

	// DeleteDocumentsDocumentIdWithResponse request
	DeleteDocumentsDocumentIdWithResponse(ctx context.Context, documentId string, params *DeleteDocumentsDocumentIdParams, reqEditors ...RequestEditorFn) (*DeleteDocumentsDocumentIdResponse, error)

	// GetDocumentsDocumentIdWithResponse request
	GetDocumentsDocumentIdWithResponse(ctx context.Context, documentId string, params *GetDocumentsDocumentIdParams, reqEditors ...RequestEditorFn) (*GetDocumentsDocumentIdResponse, error)

	// PutElementInstancesElementInstanceKeyVariablesWithBodyWithResponse request with any body
	PutElementInstancesElementInstanceKeyVariablesWithBodyWithResponse(ctx context.Context, elementInstanceKey int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PutElementInstancesElementInstanceKeyVariablesResponse, error)

	PutElementInstancesElementInstanceKeyVariablesWithResponse(ctx context.Context, elementInstanceKey int64, body PutElementInstancesElementInstanceKeyVariablesJSONRequestBody, reqEditors ...RequestEditorFn) (*PutElementInstancesElementInstanceKeyVariablesResponse, error)
	...
	GetIncidentsIncidentKeyWithResponse(ctx context.Context, incidentKey int64, reqEditors ...RequestEditorFn) (*GetIncidentsIncidentKeyResponse, error)

	// PostIncidentsIncidentKeyResolutionWithResponse request
	PostIncidentsIncidentKeyResolutionWithResponse(ctx context.Context, incidentKey int64, reqEditors ...RequestEditorFn) (*PostIncidentsIncidentKeyResolutionResponse, error)
	...
	PatchJobsJobKeyWithBodyWithResponse(ctx context.Context, jobKey int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PatchJobsJobKeyResponse, error)

	PatchJobsJobKeyWithResponse(ctx context.Context, jobKey int64, body PatchJobsJobKeyJSONRequestBody, reqEditors ...RequestEditorFn) (*PatchJobsJobKeyResponse, error)

	// PostJobsJobKeyCompletionWithBodyWithResponse request with any body
	PostJobsJobKeyCompletionWithBodyWithResponse(ctx context.Context, jobKey int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PostJobsJobKeyCompletionResponse, error)

	PostJobsJobKeyCompletionWithResponse(ctx context.Context, jobKey int64, body PostJobsJobKeyCompletionJSONRequestBody, reqEditors ...RequestEditorFn) (*PostJobsJobKeyCompletionResponse, error)

	// ThrowJobErrorWithBodyWithResponse request with any body
	ThrowJobErrorWithBodyWithResponse(ctx context.Context, jobKey int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*ThrowJobErrorResponse, error)

	ThrowJobErrorWithResponse(ctx context.Context, jobKey int64, body ThrowJobErrorJSONRequestBody, reqEditors ...RequestEditorFn) (*ThrowJobErrorResponse, error)

	// PostJobsJobKeyFailureWithBodyWithResponse request with any body
	PostJobsJobKeyFailureWithBodyWithResponse(ctx context.Context, jobKey int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PostJobsJobKeyFailureResponse, error)

	PostJobsJobKeyFailureWithResponse(ctx context.Context, jobKey int64, body PostJobsJobKeyFailureJSONRequestBody, reqEditors ...RequestEditorFn) (*PostJobsJobKeyFailureResponse, error)
	...
	PostProcessInstancesProcessInstanceKeyCancellationWithBodyWithResponse(ctx context.Context, processInstanceKey int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PostProcessInstancesProcessInstanceKeyCancellationResponse, error)

	PostProcessInstancesProcessInstanceKeyCancellationWithResponse(ctx context.Context, processInstanceKey int64, body PostProcessInstancesProcessInstanceKeyCancellationJSONRequestBody, reqEditors ...RequestEditorFn) (*PostProcessInstancesProcessInstanceKeyCancellationResponse, error)

	// PostProcessInstancesProcessInstanceKeyMigrationWithBodyWithResponse request with any body
	PostProcessInstancesProcessInstanceKeyMigrationWithBodyWithResponse(ctx context.Context, processInstanceKey int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PostProcessInstancesProcessInstanceKeyMigrationResponse, error)

	PostProcessInstancesProcessInstanceKeyMigrationWithResponse(ctx context.Context, processInstanceKey int64, body PostProcessInstancesProcessInstanceKeyMigrationJSONRequestBody, reqEditors ...RequestEditorFn) (*PostProcessInstancesProcessInstanceKeyMigrationResponse, error)
	...
	PostProcessInstancesProcessInstanceKeyMigrationWithApplicationVndCamundaAPIKeysStringPlusJSONBodyWithResponse(ctx context.Context, processInstanceKey int64, body PostProcessInstancesProcessInstanceKeyMigrationApplicationVndCamundaAPIKeysStringPlusJSONRequestBody, reqEditors ...RequestEditorFn) (*PostProcessInstancesProcessInstanceKeyMigrationResponse, error)

	// PostProcessInstancesProcessInstanceKeyModificationWithBodyWithResponse request with any body
	PostProcessInstancesProcessInstanceKeyModificationWithBodyWithResponse(ctx context.Context, processInstanceKey int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PostProcessInstancesProcessInstanceKeyModificationResponse, error)

	PostProcessInstancesProcessInstanceKeyModificationWithResponse(ctx context.Context, processInstanceKey int64, body PostProcessInstancesProcessInstanceKeyModificationJSONRequestBody, reqEditors ...RequestEditorFn) (*PostProcessInstancesProcessInstanceKeyModificationResponse, error)
	...
	PostProcessInstancesProcessInstanceKeyModificationWithApplicationVndCamundaAPIKeysStringPlusJSONBodyWithResponse(ctx context.Context, processInstanceKey int64, body PostProcessInstancesProcessInstanceKeyModificationApplicationVndCamundaAPIKeysStringPlusJSONRequestBody, reqEditors ...RequestEditorFn) (*PostProcessInstancesProcessInstanceKeyModificationResponse, error)

	// PostResourcesResourceKeyDeletionWithBodyWithResponse request with any body
	PostResourcesResourceKeyDeletionWithBodyWithResponse(ctx context.Context, resourceKey int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PostResourcesResourceKeyDeletionResponse, error)

	PostResourcesResourceKeyDeletionWithResponse(ctx context.Context, resourceKey int64, body PostResourcesResourceKeyDeletionJSONRequestBody, reqEditors ...RequestEditorFn) (*PostResourcesResourceKeyDeletionResponse, error)
...
type PostDecisionDefinitionsEvaluationResponse struct {
	Body                                      []byte
	HTTPResponse                              *http.Response
	JSON200                                   *EvaluateDecisionResponse
...
type PostDecisionDefinitionsSearchResponse struct {
	Body                                      []byte
	HTTPResponse                              *http.Response
	JSON200                                   *DecisionDefinitionSearchQueryResponse
...
type PostDecisionInstancesSearchResponse struct {
	Body                                      []byte
	HTTPResponse                              *http.Response
	JSON200                                   *DecisionInstanceSearchQueryResponse
...
type PostDecisionRequirementsSearchResponse struct {
	Body                                      []byte
	HTTPResponse                              *http.Response
	JSON200                                   *DecisionRequirementsSearchQueryResponse
...
type PostDocumentDocumentIdLinksResponse struct {
	Body                      []byte
	HTTPResponse              *http.Response
...
// Status returns HTTPResponse.Status
func (r PostDocumentDocumentIdLinksResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r PostDocumentDocumentIdLinksResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type DeleteDocumentsDocumentIdResponse struct {
	Body                      []byte
	HTTPResponse              *http.Response
	ApplicationproblemJSON404 *ProblemDetail
	ApplicationproblemJSON500 *ProblemDetail
...
// Status returns HTTPResponse.Status
func (r DeleteDocumentsDocumentIdResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r DeleteDocumentsDocumentIdResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type PostFlownodeInstancesSearchResponse struct {
	Body                                      []byte
	HTTPResponse                              *http.Response
	JSON200                                   *FlowNodeInstanceSearchQueryResponse
...
type PostIncidentsSearchResponse struct {
	Body                                      []byte
	HTTPResponse                              *http.Response
	JSON200                                   *IncidentSearchQueryResponse
...
type PostMessagesCorrelationResponse struct {
	Body                                      []byte
	HTTPResponse                              *http.Response
	JSON200                                   *MessageCorrelationResponse
...
type PostMessagesPublicationResponse struct {
	Body                                      []byte
	HTTPResponse                              *http.Response
	JSON200                                   *MessagePublicationResponse
...
type PostProcessInstancesResponse struct {
	Body                                      []byte
	HTTPResponse                              *http.Response
	JSON200                                   *CreateProcessInstanceResponse
...
type PostProcessInstancesSearchResponse struct {
	Body                                      []byte
	HTTPResponse                              *http.Response
	JSON200                                   *ProcessInstanceSearchQueryResponse
...
type PostSignalsBroadcastResponse struct {
	Body                                      []byte
	HTTPResponse                              *http.Response
	JSON200                                   *SignalBroadcastResponse
...
type PostUserTasksSearchResponse struct {
	Body                                      []byte
	HTTPResponse                              *http.Response
	JSON200                                   *UserTaskSearchQueryResponse
...
func (c *ClientWithResponses) GetDecisionDefinitionsDecisionDefinitionKeyXmlWithResponse(ctx context.Context, decisionDefinitionKey int64, reqEditors ...RequestEditorFn) (*GetDecisionDefinitionsDecisionDefinitionKeyXmlResponse, error) {
...
// PostDocumentDocumentIdLinksWithBodyWithResponse request with arbitrary body returning *PostDocumentDocumentIdLinksResponse
func (c *ClientWithResponses) PostDocumentDocumentIdLinksWithBodyWithResponse(ctx context.Context, documentId string, params *PostDocumentDocumentIdLinksParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PostDocumentDocumentIdLinksResponse, error) {
	rsp, err := c.PostDocumentDocumentIdLinksWithBody(ctx, documentId, params, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParsePostDocumentDocumentIdLinksResponse(rsp)
}

func (c *ClientWithResponses) PostDocumentDocumentIdLinksWithResponse(ctx context.Context, documentId string, params *PostDocumentDocumentIdLinksParams, body PostDocumentDocumentIdLinksJSONRequestBody, reqEditors ...RequestEditorFn) (*PostDocumentDocumentIdLinksResponse, error) {
	rsp, err := c.PostDocumentDocumentIdLinks(ctx, documentId, params, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParsePostDocumentDocumentIdLinksResponse(rsp)
...
// PostDocumentsWithBodyWithResponse request with arbitrary body returning *PostDocumentsResponse
func (c *ClientWithResponses) PostDocumentsWithBodyWithResponse(ctx context.Context, params *PostDocumentsParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PostDocumentsResponse, error) {
...
// DeleteDocumentsDocumentIdWithResponse request returning *DeleteDocumentsDocumentIdResponse
func (c *ClientWithResponses) DeleteDocumentsDocumentIdWithResponse(ctx context.Context, documentId string, params *DeleteDocumentsDocumentIdParams, reqEditors ...RequestEditorFn) (*DeleteDocumentsDocumentIdResponse, error) {
	rsp, err := c.DeleteDocumentsDocumentId(ctx, documentId, params, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseDeleteDocumentsDocumentIdResponse(rsp)
}

// GetDocumentsDocumentIdWithResponse request returning *GetDocumentsDocumentIdResponse
func (c *ClientWithResponses) GetDocumentsDocumentIdWithResponse(ctx context.Context, documentId string, params *GetDocumentsDocumentIdParams, reqEditors ...RequestEditorFn) (*GetDocumentsDocumentIdResponse, error) {
	rsp, err := c.GetDocumentsDocumentId(ctx, documentId, params, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) PutElementInstancesElementInstanceKeyVariablesWithBodyWithResponse(ctx context.Context, elementInstanceKey int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PutElementInstancesElementInstanceKeyVariablesResponse, error) {
...
func (c *ClientWithResponses) PutElementInstancesElementInstanceKeyVariablesWithResponse(ctx context.Context, elementInstanceKey int64, body PutElementInstancesElementInstanceKeyVariablesJSONRequestBody, reqEditors ...RequestEditorFn) (*PutElementInstancesElementInstanceKeyVariablesResponse, error) {
...
func (c *ClientWithResponses) GetIncidentsIncidentKeyWithResponse(ctx context.Context, incidentKey int64, reqEditors ...RequestEditorFn) (*GetIncidentsIncidentKeyResponse, error) {
...
func (c *ClientWithResponses) PostIncidentsIncidentKeyResolutionWithResponse(ctx context.Context, incidentKey int64, reqEditors ...RequestEditorFn) (*PostIncidentsIncidentKeyResolutionResponse, error) {
...
func (c *ClientWithResponses) PatchJobsJobKeyWithBodyWithResponse(ctx context.Context, jobKey int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PatchJobsJobKeyResponse, error) {
...
func (c *ClientWithResponses) PatchJobsJobKeyWithResponse(ctx context.Context, jobKey int64, body PatchJobsJobKeyJSONRequestBody, reqEditors ...RequestEditorFn) (*PatchJobsJobKeyResponse, error) {
...
func (c *ClientWithResponses) PostJobsJobKeyCompletionWithBodyWithResponse(ctx context.Context, jobKey int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PostJobsJobKeyCompletionResponse, error) {
...
func (c *ClientWithResponses) PostJobsJobKeyCompletionWithResponse(ctx context.Context, jobKey int64, body PostJobsJobKeyCompletionJSONRequestBody, reqEditors ...RequestEditorFn) (*PostJobsJobKeyCompletionResponse, error) {
...
func (c *ClientWithResponses) ThrowJobErrorWithBodyWithResponse(ctx context.Context, jobKey int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*ThrowJobErrorResponse, error) {
...
func (c *ClientWithResponses) ThrowJobErrorWithResponse(ctx context.Context, jobKey int64, body ThrowJobErrorJSONRequestBody, reqEditors ...RequestEditorFn) (*ThrowJobErrorResponse, error) {
...
func (c *ClientWithResponses) PostJobsJobKeyFailureWithBodyWithResponse(ctx context.Context, jobKey int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PostJobsJobKeyFailureResponse, error) {
...
func (c *ClientWithResponses) PostJobsJobKeyFailureWithResponse(ctx context.Context, jobKey int64, body PostJobsJobKeyFailureJSONRequestBody, reqEditors ...RequestEditorFn) (*PostJobsJobKeyFailureResponse, error) {
...
func (c *ClientWithResponses) PostProcessInstancesProcessInstanceKeyCancellationWithBodyWithResponse(ctx context.Context, processInstanceKey int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PostProcessInstancesProcessInstanceKeyCancellationResponse, error) {
...
func (c *ClientWithResponses) PostProcessInstancesProcessInstanceKeyCancellationWithResponse(ctx context.Context, processInstanceKey int64, body PostProcessInstancesProcessInstanceKeyCancellationJSONRequestBody, reqEditors ...RequestEditorFn) (*PostProcessInstancesProcessInstanceKeyCancellationResponse, error) {
...
func (c *ClientWithResponses) PostProcessInstancesProcessInstanceKeyMigrationWithBodyWithResponse(ctx context.Context, processInstanceKey int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PostProcessInstancesProcessInstanceKeyMigrationResponse, error) {
...
func (c *ClientWithResponses) PostProcessInstancesProcessInstanceKeyMigrationWithResponse(ctx context.Context, processInstanceKey int64, body PostProcessInstancesProcessInstanceKeyMigrationJSONRequestBody, reqEditors ...RequestEditorFn) (*PostProcessInstancesProcessInstanceKeyMigrationResponse, error) {
...
func (c *ClientWithResponses) PostProcessInstancesProcessInstanceKeyModificationWithBodyWithResponse(ctx context.Context, processInstanceKey int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PostProcessInstancesProcessInstanceKeyModificationResponse, error) {
...
func (c *ClientWithResponses) PostProcessInstancesProcessInstanceKeyModificationWithResponse(ctx context.Context, processInstanceKey int64, body PostProcessInstancesProcessInstanceKeyModificationJSONRequestBody, reqEditors ...RequestEditorFn) (*PostProcessInstancesProcessInstanceKeyModificationResponse, error) {
...
func (c *ClientWithResponses) PostResourcesResourceKeyDeletionWithBodyWithResponse(ctx context.Context, resourceKey int64, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PostResourcesResourceKeyDeletionResponse, error) {
...
func (c *ClientWithResponses) PostResourcesResourceKeyDeletionWithResponse(ctx context.Context, resourceKey int64, body PostResourcesResourceKeyDeletionJSONRequestBody, reqEditors ...RequestEditorFn) (*PostResourcesResourceKeyDeletionResponse, error) {
...
// ParsePostDocumentDocumentIdLinksResponse parses an HTTP response from a PostDocumentDocumentIdLinksWithResponse call
func ParsePostDocumentDocumentIdLinksResponse(rsp *http.Response) (*PostDocumentDocumentIdLinksResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &PostDocumentDocumentIdLinksResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParseDeleteDocumentsDocumentIdResponse parses an HTTP response from a DeleteDocumentsDocumentIdWithResponse call
func ParseDeleteDocumentsDocumentIdResponse(rsp *http.Response) (*DeleteDocumentsDocumentIdResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &DeleteDocumentsDocumentIdResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
