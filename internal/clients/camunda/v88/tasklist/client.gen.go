...
type TaskResponse struct {
	...
	// Priority The priority of a user task. The higher the value the higher the priority. Applicable only for job worker-based user tasks managed by Camunda.
...
type TaskSearchRequest struct {
	...
	// Priority Rules to filter out tasks by their priority. Applicable only for job worker-based user tasks managed by Camunda.
	Priority *struct {
