...
// Client returns the generated Camunda element client used by the v8.10 service.
func (s *Service) Client() GenElementClient { return s.c }

// Config returns the normalized service configuration used by the v8.10 element service.
func (s *Service) Config() *config.Config { return s.cfg }

// Logger returns the service logger used by the v8.10 element service.
func (s *Service) Logger() *slog.Logger { return s.log }

// Option customizes the v8.10 element service during construction.
...
// New prepares a v8.10 element service with the generated Camunda v2 client.
...
func (s *Service) GetElement(ctx context.Context, key string, opts ...services.CallOption) (d.Element, error) {
	...
	resp, err := s.c.GetElementInstanceWithResponse(ctx, camundav810.ElementInstanceKey(key))
	if err != nil {
...
func (s *Service) SearchElementsPage(ctx context.Context, query d.ElementSearchQuery, pageReq d.ElementPageRequest, opts ...services.CallOption) (d.ElementSearchPage, error) {
	...
	resp, err := s.c.SearchElementInstancesWithResponse(ctx, camundav810.SearchElementInstancesJSONRequestBody{
		Filter: filter,
		Page:   &page,
	})
	if err != nil {
...
func trimElementSearchPageResults(items []camundav810.ElementInstanceResult, page camundav810.SearchQueryPageResponse, from int32, pageSize int32) []camundav810.ElementInstanceResult {
...
func pickElementSearchOverflowState(page camundav810.SearchQueryPageResponse, from int32, itemCount int, pageSize int32) d.ProcessInstanceOverflowState {
	if itemCount == 0 {
