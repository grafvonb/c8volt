...
// testConfig returns the minimal config needed to construct versioned process-instance services.
...
func TestFactory_StableVersionSelectionUnchanged(t *testing.T) {
	tests := []struct {
		...
		{name: "v87", version: toolx.V87, assert: func(t *testing.T, svc processinstance.API) { require.IsType(t, &v87.Service{}, svc) }},
		{name: "v88", version: toolx.V88, assert: func(t *testing.T, svc processinstance.API) { require.IsType(t, &v88.Service{}, svc) }},
		{name: "v89", version: toolx.V89, assert: func(t *testing.T, svc processinstance.API) { require.IsType(t, &v89.Service{}, svc) }},
		{name: "current-default", version: toolx.CurrentCamundaVersion, assert: func(t *testing.T, svc processinstance.API) { require.IsType(t, &v89.Service{}, svc) }},
	}
