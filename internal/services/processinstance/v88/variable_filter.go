...
func newVariableStringFilter(clause d.ProcessInstanceVariableFilterClause) (camundav88.StringFilterProperty, error) {
	...
	case d.ProcessInstanceVariableFilterOperatorNeq:
		if err := valueFilter.FromAdvancedStringFilter(camundav88.AdvancedStringFilter{Neq: &clause.Value}); err != nil {
			return camundav88.StringFilterProperty{}, err
		}
		return valueFilter, nil
	case d.ProcessInstanceVariableFilterOperatorIn:
		...
		if err := valueFilter.FromAdvancedStringFilter(camundav88.AdvancedStringFilter{In: &values}); err != nil {
			return camundav88.StringFilterProperty{}, err
		}
		return valueFilter, nil
	case d.ProcessInstanceVariableFilterOperatorNotIn:
		...
		if err := valueFilter.FromAdvancedStringFilter(camundav88.AdvancedStringFilter{NotIn: &values}); err != nil {
			return camundav88.StringFilterProperty{}, err
		}
		return valueFilter, nil
