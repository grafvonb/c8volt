...
func (s *Service) waitForDeploymentConfirmation(ctx context.Context, dr camundav810.DeploymentResult, vtenantID string, suppressDetailLogs bool) error {
...
func (s *Service) processDefinitionDeployPoller(dr camundav810.DeploymentResult) func(context.Context) (poller.JobPollStatus, error) {
	keys := resourcepayload.DeploymentProcessDefinitionKeys(dr.Deployments, func(dep camundav810.DeploymentMetadataResult) string {
