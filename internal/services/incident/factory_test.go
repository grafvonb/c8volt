...
// testConfig returns the minimal config needed to construct versioned incident services.
...
func TestFactory_SupportedVersions(t *testing.T) {
	tests := []struct {
		...
		{name: "v810", version: toolx.V810, assert: func(t *testing.T, svc incident.API) { require.IsType(t, &v810.Service{}, svc) }},
	}
...
func TestFactory_StableVersionSelectionUnchanged(t *testing.T) {
	tests := []struct {
		...
		{name: "v88", version: toolx.V88, assert: func(t *testing.T, svc incident.API) { require.IsType(t, &v88.Service{}, svc) }},
		{name: "v89", version: toolx.V89, assert: func(t *testing.T, svc incident.API) { require.IsType(t, &v89.Service{}, svc) }},
		{name: "current-default", version: toolx.CurrentCamundaVersion, assert: func(t *testing.T, svc incident.API) { require.IsType(t, &v88.Service{}, svc) }},
	}
...
// TestFactory_APIExposesTopLevelIncidentSearch keeps the public service contract intact.
