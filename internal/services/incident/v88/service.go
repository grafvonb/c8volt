...
// Service implements incident operations through the Camunda 8.8 API.
type Service struct {
...
// Option configures a v8.8 incident service.
...
// New creates a v8.8 incident service with generated Camunda client dependencies.
