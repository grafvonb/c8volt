...
type mockJobClient struct {
	searchJobsWithResponse    func(context.Context, camundav810.SearchJobsJSONRequestBody, ...camundav810.RequestEditorFn) (*camundav810.SearchJobsResponse, error)
	updateJobWithResponse     func(context.Context, camundav810.JobKey, camundav810.UpdateJobJSONRequestBody, ...camundav810.RequestEditorFn) (*camundav810.UpdateJobResponse, error)
	completeJobWithResponse   func(context.Context, camundav810.JobKey, camundav810.CompleteJobJSONRequestBody, ...camundav810.RequestEditorFn) (*camundav810.CompleteJobResponse, error)
	throwJobErrorWithResponse func(context.Context, camundav810.JobKey, camundav810.ThrowJobErrorJSONRequestBody, ...camundav810.RequestEditorFn) (*camundav810.ThrowJobErrorResponse, error)
	failJobWithResponse       func(context.Context, camundav810.JobKey, camundav810.FailJobJSONRequestBody, ...camundav810.RequestEditorFn) (*camundav810.FailJobResponse, error)
}

func (m *mockJobClient) SearchJobsWithResponse(ctx context.Context, body camundav810.SearchJobsJSONRequestBody, reqEditors ...camundav810.RequestEditorFn) (*camundav810.SearchJobsResponse, error) {
	return m.searchJobsWithResponse(ctx, body, reqEditors...)
}

func (m *mockJobClient) UpdateJobWithResponse(ctx context.Context, jobKey camundav810.JobKey, body camundav810.UpdateJobJSONRequestBody, reqEditors ...camundav810.RequestEditorFn) (*camundav810.UpdateJobResponse, error) {
...
func (m *mockJobClient) CompleteJobWithResponse(ctx context.Context, jobKey camundav810.JobKey, body camundav810.CompleteJobJSONRequestBody, reqEditors ...camundav810.RequestEditorFn) (*camundav810.CompleteJobResponse, error) {
...
func (m *mockJobClient) ThrowJobErrorWithResponse(ctx context.Context, jobKey camundav810.JobKey, body camundav810.ThrowJobErrorJSONRequestBody, reqEditors ...camundav810.RequestEditorFn) (*camundav810.ThrowJobErrorResponse, error) {
...
func (m *mockJobClient) FailJobWithResponse(ctx context.Context, jobKey camundav810.JobKey, body camundav810.FailJobJSONRequestBody, reqEditors ...camundav810.RequestEditorFn) (*camundav810.FailJobResponse, error) {
...
// TestSearchJobsByKey verifies v8.10 key lookup builds a job-key search and maps the returned row.
func TestSearchJobsByKey(t *testing.T) {
	deadline := time.Date(2026, 5, 8, 10, 15, 0, 0, time.UTC)
	svc := newJobServiceTest(t, &mockJobClient{
		searchJobsWithResponse: func(_ context.Context, body camundav810.SearchJobsJSONRequestBody, _ ...camundav810.RequestEditorFn) (*camundav810.SearchJobsResponse, error) {
			requireJobSearchBody(t, body, "2251799813711967")
			return &camundav810.SearchJobsResponse{
				HTTPResponse: okHTTPResponse(),
				JSON200: &camundav810.JobSearchQueryResult{
					Items: []camundav810.JobSearchResult{{
						JobKey:             "2251799813711967",
						State:              camundav810.JobStateEnum("FAILED"),
						Retries:            2,
						Deadline:           &deadline,
...
// TestService_GetJob_NotFound verifies an empty v8.10 job search result maps to the shared not-found error.
...
// TestService_SearchJobs_ConstructsFiltersAndConvertsRows verifies v8.10 job
...
func TestService_SearchJobs_ConstructsFiltersAndConvertsRows(t *testing.T) {
	retries := int32(0)
	elementID := camundav810.ElementId("charge-card")
	svc := newJobServiceTest(t, &mockJobClient{
		searchJobsWithResponse: func(_ context.Context, body camundav810.SearchJobsJSONRequestBody, _ ...camundav810.RequestEditorFn) (*camundav810.SearchJobsResponse, error) {
			...
			return &camundav810.SearchJobsResponse{
				...
				JSON200: &camundav810.JobSearchQueryResult{
					Items: []camundav810.JobSearchResult{{
						JobKey:             "2251799813711967",
						State:              camundav810.JobStateEnumFAILED,
						Retries:            retries,
						Type:               "payment-worker",
						Worker:             "worker-a",
						Kind:               camundav810.JobKindEnumBPMNELEMENT,
						ListenerEventType:  camundav810.JobListenerEventTypeEnumCOMPLETING,
						ProcessInstanceKey: "2251799813711000",
						ElementInstanceKey: "2251799813711001",
						ElementId:          &elementID,
						TenantId:           "tenant-a",
...
// TestService_SearchJobsPagesByBatchSizeUntilComplete verifies service-owned offset paging for v8.10 job search.
func TestService_SearchJobsPagesByBatchSizeUntilComplete(t *testing.T) {
	var requests []camundav810.SearchJobsJSONRequestBody
	svc := newJobServiceTest(t, &mockJobClient{
		searchJobsWithResponse: func(_ context.Context, body camundav810.SearchJobsJSONRequestBody, _ ...camundav810.RequestEditorFn) (*camundav810.SearchJobsResponse, error) {
			requests = append(requests, body)
			key := camundav810.JobKey("2251799813711967")
			if len(requests) == 2 {
...
// TestService_SearchJobsLimitCapsPagedSearch verifies caller limits trim v8.10 job search traversal.
...
// TestJobUpdateRetriesRequest verifies v8.10 retry updates submit only the retry changeset when confirmation is skipped.
func TestJobUpdateRetriesRequest(t *testing.T) {
	...
	svc := newJobServiceTest(t, &mockJobClient{
		...
		updateJobWithResponse: func(_ context.Context, jobKey camundav810.JobKey, body camundav810.UpdateJobJSONRequestBody, _ ...camundav810.RequestEditorFn) (*camundav810.UpdateJobResponse, error) {
			require.Equal(t, camundav810.JobKey("2251799813711967"), jobKey)
			...
			return &camundav810.UpdateJobResponse{
...
// TestUpdateJobTimeoutRequest verifies v8.10 timeout updates submit only the timeout changeset.
...
// TestUpdateJobRetriesAndTimeoutRequest verifies v8.10 combined retry and timeout updates preserve both values.
...
// TestUpdateJobRetriesConfirmsViaV810Search proves retry confirmation stays on the native v8.10 job search path.
func TestUpdateJobRetriesConfirmsViaV810Search(t *testing.T) {
	retries := int32(3)
	searches := 0
	svc := newJobServiceTest(t, &mockJobClient{
		updateJobWithResponse: func(_ context.Context, jobKey camundav810.JobKey, body camundav810.UpdateJobJSONRequestBody, _ ...camundav810.RequestEditorFn) (*camundav810.UpdateJobResponse, error) {
		...
		searchJobsWithResponse: func(_ context.Context, body camundav810.SearchJobsJSONRequestBody, _ ...camundav810.RequestEditorFn) (*camundav810.SearchJobsResponse, error) {
			...
			return &camundav810.SearchJobsResponse{
				...
				JSON200: &camundav810.JobSearchQueryResult{
					Items: []camundav810.JobSearchResult{{
						JobKey:  "2251799813711967",
						State:   camundav810.JobStateEnumRETRIESUPDATED,
						Retries: retries,
					}},
				},
			}, nil
	...
	require.NoError(t, err)
	require.True(t, result.MutationAccepted)
	require.Equal(t, "confirmed", result.ConfirmationStatus)
	require.Equal(t, &retries, result.ConfirmedRetries)
	require.Equal(t, 1, searches)
}

// TestSubmitJobTechnicalFailureRequest verifies v8.10 technical-failure payload conversion.
func TestSubmitJobTechnicalFailureRequest(t *testing.T) {
	...
	svc := newJobServiceTest(t, &mockJobClient{
		...
		failJobWithResponse: func(_ context.Context, jobKey camundav810.JobKey, body camundav810.FailJobJSONRequestBody, _ ...camundav810.RequestEditorFn) (*camundav810.FailJobResponse, error) {
			require.Equal(t, camundav810.JobKey("2251799813711967"), jobKey)
			...
			return &camundav810.FailJobResponse{
...
// TestSubmitJobBPMNErrorRequest verifies v8.10 BPMN-error payload conversion.
func TestSubmitJobBPMNErrorRequest(t *testing.T) {
	svc := newJobServiceTest(t, &mockJobClient{
		...
		throwJobErrorWithResponse: func(_ context.Context, jobKey camundav810.JobKey, body camundav810.ThrowJobErrorJSONRequestBody, _ ...camundav810.RequestEditorFn) (*camundav810.ThrowJobErrorResponse, error) {
			require.Equal(t, camundav810.JobKey("2251799813711967"), jobKey)
			...
			return &camundav810.ThrowJobErrorResponse{
...
// TestSubmitJobCompletionRequest verifies v8.10 completion payload conversion with variables.
func TestSubmitJobCompletionRequest(t *testing.T) {
	svc := newJobServiceTest(t, &mockJobClient{
		...
		completeJobWithResponse: func(_ context.Context, jobKey camundav810.JobKey, body camundav810.CompleteJobJSONRequestBody, _ ...camundav810.RequestEditorFn) (*camundav810.CompleteJobResponse, error) {
			require.Equal(t, camundav810.JobKey("2251799813711967"), jobKey)
			require.NotNil(t, body.Variables)
			require.Equal(t, map[string]any{"approved": true}, *body.Variables)
			return &camundav810.CompleteJobResponse{
...
// TestSubmitJobCompletionWithoutVariables verifies v8.10 completion still sends the required variables object.
func TestSubmitJobCompletionWithoutVariables(t *testing.T) {
	svc := newJobServiceTest(t, &mockJobClient{
		...
		completeJobWithResponse: func(_ context.Context, _ camundav810.JobKey, body camundav810.CompleteJobJSONRequestBody, _ ...camundav810.RequestEditorFn) (*camundav810.CompleteJobResponse, error) {
			require.NotNil(t, body.Variables)
...
func requireJobSearchBody(t *testing.T, body camundav810.SearchJobsJSONRequestBody, key string) {
	t.Helper()
	require.NotNil(t, body.Filter)
	require.NotNil(t, body.Filter.JobKey)
	gotKey, err := body.Filter.JobKey.AsJobKeyFilterProperty0()
	require.NoError(t, err)
	require.Equal(t, camundav810.JobKey(key), gotKey)
...
func requireJobSearchFilterJSON(t *testing.T, body camundav810.SearchJobsJSONRequestBody, want map[string]any, wantLimit int32) {
	t.Helper()
...
func requireJobSearchPageJSON(t *testing.T, body camundav810.SearchJobsJSONRequestBody, wantFrom int32, wantLimit int32) {
	t.Helper()
	raw, err := json.Marshal(body)
	require.NoError(t, err)
	var got map[string]any
