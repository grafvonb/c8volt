...
// decodeSearchVariablesResponse reads raw JSON because the generated v8.10 model drops value and truncation fields.
func decodeSearchVariablesResponse(body []byte, page *camundav810.VariableSearchQueryResult) (variableSearchQueryResult, error) {
