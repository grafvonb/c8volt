...
// Service implements variable operations through the Camunda 8.10 API.
type Service struct {
...
// Option configures a v8.10 variable service.
...
// New creates a v8.10 variable service with generated Camunda client dependencies.
