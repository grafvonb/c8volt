...
// Service implements variable operations through the Camunda 8.9 API.
type Service struct {
...
// Option configures a v8.9 variable service.
...
// New creates a v8.9 variable service with generated Camunda client dependencies.
