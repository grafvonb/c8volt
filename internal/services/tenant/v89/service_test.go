	...
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mockTenantClient) {
				...
				m.On("SearchTenantsWithResponse", mock.Anything, mock.MatchedBy(func(body camundav89.SearchTenantsJSONRequestBody) bool {
		...
		},
		{
			name: "client error",
			setupMock: func(m *mockTenantClient) {
				m.On("SearchTenantsWithResponse", mock.Anything, mock.Anything).Return((*camundav89.SearchTenantsResponse)(nil), mockErr)
			},
