...
| The CLI targets Camunda 8.7, 8.8, 8.9, and 8.10, with version-dependent behavior called out for several operations. | `README.md` "Supported Camunda Versions"; `config/templates/config.example.yaml`; `cmd/root.go` help text | High | Establishes version compatibility as a central architectural force. |
...
| Generated API-client boundary | `internal/clients/camunda/v86`; `internal/clients/camunda/v87`; `internal/clients/camunda/v88`; `internal/clients/camunda/v89`; `internal/clients/camunda/v810`; `api/refresh-clients.sh`; `go.mod` tool declarations | Service factories choose clients based on config/version | HTTP request/response translation to upstream APIs | V810 records exact machine-readable upstream provenance beside its generated client; provenance for older generated clients is only partially visible. Client presence alone does not prove supported CLI behavior. |
...
| Internal services | Generated clients | `internal/services/*/factory.go`; `internal/clients/camunda/v87`; `v88`; `v89`; `v810` | Services select versioned generated clients. | Version-specific upstream API differences are isolated below services. |
